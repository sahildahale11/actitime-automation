...
public class TestNgUserTask {
    ...
    public void userTask() throws Exception {
        ...
        // click on Add Users
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//th[@id='sortByPTOControl']/preceding::span[text()='All Users']"))).click();        //click On Selected user
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//SPAN[@class='label'][text()='Add rates'])[1]")));
        actions.scrollToElement(driver.findElement(By.xpath("(//SPAN[@class='label'][text()='Add rates'])[1]"))).build().perform();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//SPAN[@class='label'][text()='Add rates'])[1]"))).click();
...
// Print the text
        ...
        Assert.assertEquals("10000.00", "10000.00", "Test Case Passed,Value Matched");
